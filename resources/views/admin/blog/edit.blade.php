                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-6">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="featured" value="1" {{ $blog->featured ? 'checked' : '' }}
                            class="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <span class="mr-2 text-gray-700">بله</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="featured" value="0" {{ !$blog->featured ? 'checked' : '' }}
                            class="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <span class="mr-2 text-gray-700">خیر</span>
                        </label>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">در صورت انتخاب «بله»، این مقاله به عنوان پست ویژه نمایش داده می‌شود.</p>
                </div>
