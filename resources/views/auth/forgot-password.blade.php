...
@section('main')
    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-gray-200/60 p-6 sm:p-8 border border-gray-100">
        ...
        <div class="text-center mb-6 sm:mb-8">
            <h2 class="text-xl sm:text-2xl font-black text-gray-900">بازیابی رمز عبور 🔑</h2>
            <p class="text-gray-500 mt-2 text-sm">شماره تلفن خود را وارد کنید تا کد بازیابی ارسال شود</p>
        </div>
